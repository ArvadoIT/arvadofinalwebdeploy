...
const chapters = [
  {
    ...
    accent:
      "radial-gradient(540px 400px at 20% 25%, rgba(14,165,233,0.28), transparent 65%), radial-gradient(420px 360px at 80% 75%, rgba(99,102,241,0.25), transparent 60%)",
  },
  {
    slug: "design",
    label: "Chapter 02",
    ...
    accent:
      "radial-gradient(520px 380px at 25% 30%, rgba(236,72,153,0.28), transparent 65%), radial-gradient(380px 320px at 70% 70%, rgba(56,189,248,0.25), transparent 60%)",
  },
  {
    slug: "build",
    label: "Chapter 03",
    ...
    accent:
      "radial-gradient(520px 380px at 30% 30%, rgba(56,189,248,0.28), transparent 65%), radial-gradient(420px 320px at 70% 70%, rgba(14,165,233,0.25), transparent 60%)",
  },
  {
    slug: "launch",
    label: "Chapter 04",
    ...
    accent:
      "radial-gradient(520px 380px at 70% 30%, rgba(99,102,241,0.3), transparent 65%), radial-gradient(420px 320px at 30% 70%, rgba(236,72,153,0.26), transparent 60%)",
  },
] as const;
        ...
        {chapters.map((chapter, index) => (
          ...
          >
            <div className="relative grid min-h-screen place-items-center px-6 py-16 sm:py-24 lg:px-12">
              <div className="glass-panel relative w-full max-w-5xl overflow-hidden rounded-4xl border border-white/10 bg-white/5 px-8 py-12 text-left md:px-12 md:py-16">
                <div
